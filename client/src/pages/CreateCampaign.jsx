...
const CreateCampaign = () => {
  ...
  return (
    ...
    rounded-[10px] sm:p-10 p-4'>
      {isLoading && <Loader />}
      <div className='flex jusify-center items-center p-[16px] sm:min-w-[380px] bg-[#3a3a43]
      rounded-[15px]'>
      ...
      <form onSubmit={handleSubmit} className='w-full mt-[65px] flex flex-col gap-[30px]' >
        ...
        <FormField 
          ...
          />
          <div className='bg-[#8c6dfd] flex w-full h-[120px] rounded-[10px] justify-start items-center p-4'>
